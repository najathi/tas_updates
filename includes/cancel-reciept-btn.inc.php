...
if (isset($_POST['ex_id'])) {
    ...
    $sqlCnBtn = "UPDATE exchange_order SET receipt = 0 WHERE ex_id = '$ex_id'";
        ...
        while ($row = mysqli_fetch_array($result)) {
            $output .= '  
                    ...
                    <tr>
                        ...
                        <td>';
            if ($row['receipt']== 0) {
                $output .= '<button type="button" class="btn btn-primary btn-xs mk-reciept" id="'.$row['ex_id'].'">Make Receipt</button>';
                ...
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <a class="text-danger cancel-reciept" id="'.$row['ex_id'].'" data-toggle="tooltip" data-placement="top" title="Cancel Reciept"><i class="fa fa-close"></i></a>
              ';
            }
