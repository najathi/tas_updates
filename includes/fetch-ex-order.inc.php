...
foreach ($result as $row) {
    ...
    $sub_array[] = '<a href="pdf_supplier_copy?ex_id='.$row['ex_id'].'" target="_blank" class="com_pfd" style="cursor: pointer;" data-toggle="tooltip" id="'.$row['ex_id'].'" data-placement="top" title="Supplier Copy"><span style="color:red;"><i class="fa fa-print"></i></span></a>
    &nbsp;&nbsp;|&nbsp;&nbsp;
