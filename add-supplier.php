...
include_once 'includes/supp_id-count.php';
?>
<!doctype html>
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Here add new Supplier of <code>Supplier Information</code>.</p>
                                        <form action="includes/add-supplier.inc.php" method="POST">
                                            <fieldset disabled>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        <label for="example-text-input" class="col-form-label">Supplier ID</label>
                                                        <input type="text" value="<?php printf("%06d", $countSuppID); ?>" name="supp_id" class="form-control" value="">
                                                    </div>
                                                </div>
                                            </fieldset>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="supp_name" class="form-control" placeholder="Supplier Name" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <label for="example-text-input" class="col-form-label">Phone No.</label>
                                                    <input type="text" name="supp_tele" class="form-control" placeholder="Phone Number">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <label for="example-text-input" class="col-form-label">Email Address</label>
                                                    <input type="email" name="supp_email" class="form-control" placeholder="Email">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <label for="example-text-input" class="col-form-label">Address Line 1</label>
                                                    <input type="text" name="supp_address_one" class="form-control" placeholder="Address Line I">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <label for="example-text-input" class="col-form-label">Address Line 2</label>
                                                    <input type="text" name="supp_address_two" class="form-control" placeholder="Address Line II">
                                                </div>
                                            </div>
                                            <button style="margin-top: 1rem;" class="btn btn-primary" name="submitAddSupp" type="submit">Add Supplier</button>
