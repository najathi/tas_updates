...
<head>
    ...
    <title>Search Supplier - TAS</title>
    ...
    <div class="page-container">
                            ...
                            if ($_SESSION['user_role_id'] == 1) {
                                ...
                                <li class="active">
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="active"><a href="search-supplier">Search</a></li>
                                    </ul>
                                </li>
                                <li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                if (strpos($fullUrl, "supp=Updated") == true) {
                            ...
                            <div class="card-body">
                                ...
                                <div class="single-table">
                                    <div class="table-responsive">
                                        ...
                                        <table id="suppTable" class="table table-hover progress-table text-center">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="example-text-input" class="col-form-label">Supplier ID</label>
                                                                        <input type="text" readonly="readonly" name="supp_id" id="supp_id" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="example-text-input" class="col-form-label">Name</label>
                                                                        <input type="text" name="supp_name" id="supp_name" class="form-control" placeholder="Supplier Name" required>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="example-text-input" class="col-form-label">Phone No.</label>
                                                                        <input type="text" name="supp_tele" id="supp_tele" class="form-control" placeholder="Phone Number">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="example-text-input" class="col-form-label">Email Address</label>
                                                                        <input type="text" name="supp_email" id="supp_email" class="form-control" placeholder="Email">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="example-text-input" class="col-form-label">Address Line 1</label>
                                                                        <input type="text" name="supp_address_one" id="supp_address_one" class="form-control" placeholder="Address line II">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="example-text-input" class="col-form-label">Address Line 2</label>
                                                                        <input type="text" name="supp_address_two" id="supp_address_two" class="form-control" placeholder="Address line II">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="example-text-input" class="col-form-label">Date & Time</label>
                                                                        <input type="text" name="supp_date" id="supp_date" class="form-control" placeholder="Data & Time" readonly="readonly">
                                                                    </div>
                                                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $.ajax({
                    url: "includes/fetch-supplier.inc.php",
                    method: "POST",
                    data: {
                        supp_id: supp_id
                    },
                    ...
                    success: function(data) {
                        ...
                        $('#supp_tele').val(data.supp_tele);
                        $('#supp_email').val(data.supp_email);
                        $('#supp_address_one').val(data.supp_address_one);
                        $('#supp_address_two').val(data.supp_address_two);
                        $('#supp_date').val(data.supp_date);
            ...
            $('#insert_form').on("submit", function(event) {
                ...
                $.ajax({
                    url: "includes/supplier-edit.inc.php",
                    method: "POST",
            ...
            // data table
            var dataTable = $('#suppTable').DataTable({
                language: {
                ...
                "autoWidth": false,
                "ajax": {
                    url: "includes/fetch-supplier-dt.inc.php",
                    type: "POST"
                },
                "columnDefs": [{
                    "targets": [0, 6],
