                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <textarea name="from_to[]" class="form-control" aria-label="With textarea" id="from_to0" required></textarea>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <input name="depart_date[]" class="form-control" type="date" id="depart_date0" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
