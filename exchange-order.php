                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-12 mb-3 row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input class="form-control" value="<?php echo $row['Lastname']; ?>" type="text" id="counter_staff" readonly="readonly">
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-3 row">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input name="p_name[]" class="form-control" type="text" id="p_name0" required>
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        <label for="validationCustom03">Ticket No.</label>
                                                        <input name="ticket_no[]" type="text" class="form-control" id="ticket_no0" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <textarea name="pass_remark[]" id="pass_remark" cols="30" rows="4" class="form-control"></textarea>
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input name="basicc[]" type="number" step=".01" class="form-control form-control-sm" id="basicc0" onkeyup="calc(this)" required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationCustom04">yq (0.00)</label>
                                                            <input name="yq[]" type="number" step=".01" class="form-control form-control-sm" id="yq0" onkeyup="calc(this)" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationCustom03">yr (0.00)</label>
                                                            <input name="yr[]" type="number" step=".01" class="form-control form-control-sm" id="yr0" onkeyup="calc(this)" required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input name="supp_charge[]" type="number" step=".01" class="form-control form-control-sm" id="supp_charge0" onkeyup="calc(this)" required>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationCustom03">Service Amount (0.00)</label>
                                                            <input name="service_amt[]" type="number" step=".01" class="form-control form-control-sm" id="service_amt0" onkeyup="calc(this)" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <textarea name="from_to[]" class="form-control" aria-label="With textarea" id="from_to0"></textarea>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <input name="depart_date[]" class="form-control" type="date" id="depart_date0">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="col-lg-12 mt-12">
                                                                    <div class="single-table">
                                                                        <div class="table-responsive">
                                                                            <table class="table text-center" id="viewPassTable">
