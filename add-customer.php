    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                } elseif (strpos($fullUrl, "cus=added") == true) {
                                        ...
                                        <form action="includes/customer/add-customer.inc.php" method="POST">
                                            <fieldset disabled>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        <label for="example-text-input" class="col-form-label">Customer A/C Code</label>
                                                        <input type="text" value="<?php printf("%06d", $countcusAC); ?>" name="cus_ac_code" class="form-control" value="">
                                                    </div>
                                                </div>
                                            </fieldset>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="c_tele_no" class="form-control" placeholder="Phone Number">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="c_address_one" class="form-control" placeholder="Address Line I">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <label for="example-text-input" class="col-form-label">Address Line 2</label>
                                                    <input type="text" name="c_address_two" class="form-control" placeholder="Address Line II">
                                                </div>
                                            </div>
                                            <button style="margin-top: 1rem;" class="btn btn-primary" name="submitCusAdd" type="submit">Add Customer</button>
